...
def send_email(smtpHost, sendAddr, password, recipientAddrs, addr, subject='', content=''):
    ...
    part = MIMEApplication(open(addr,'rb').read())
...
if __name__ == "__main__":
    ...
    try:
        ...
        send_email('smtp.163.com', 'yanghaotai@163.com', '15811307862yht', ['596532245@qq.com','373640112@qq.com'], report_path, subject, content)
